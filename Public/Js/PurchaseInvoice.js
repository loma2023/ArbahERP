...
const INVENTORY_DATA = {
    items: [
        { _id: "itm_001", code: "ITM-001", name: "لابتوب Dell Latitude 5520", category: "أجهزة كمبيوتر", prices: { cost: 3800, wholesale: 4200, retail: 4500, vip: 4000 }, units: [{ unit: "جهاز", price: 4500, isDefault: true }, { unit: "كرتونة", price: 22000, isDefault: false }], stock: { quantity: 15, minLevel: 5, maxLevel: 50 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_002", code: "ITM-002", name: "ماوس لاسلكي Logitech", category: "ملحقات", prices: { cost: 85, wholesale: 100, retail: 120, vip: 110 }, units: [{ unit: "قطعة", price: 120, isDefault: true }, { unit: "دزينة", price: 1200, isDefault: false }, { unit: "كرتونة", price: 5000, isDefault: false }], stock: { quantity: 50, minLevel: 20, maxLevel: 100 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_003", code: "ITM-003", name: "كيبورد ميكانيكي Redragon", category: "ملحقات", prices: { cost: 220, wholesale: 250, retail: 280, vip: 260 }, units: [{ unit: "قطعة", price: 280, isDefault: true }, { unit: "كرتونة", price: 2500, isDefault: false }], stock: { quantity: 30, minLevel: 10, maxLevel: 80 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_004", code: "ITM-004", name: "شاشة Samsung 27 بوصة", category: "شاشات", prices: { cost: 1000, wholesale: 1100, retail: 1200, vip: 1150 }, units: [{ unit: "جهاز", price: 1200, isDefault: true }, { unit: "كرتونة", price: 5500, isDefault: false }], stock: { quantity: 8, minLevel: 3, maxLevel: 30 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_005", code: "ITM-005", name: "طابعة HP LaserJet", category: "طابعات", prices: { cost: 720, wholesale: 800, retail: 850, vip: 820 }, units: [{ unit: "جهاز", price: 850, isDefault: true }, { unit: "كرتونة", price: 4000, isDefault: false }], stock: { quantity: 12, minLevel: 5, maxLevel: 40 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_006", code: "ITM-006", name: "راوتر TP-Link AC1200", category: "شبكات", prices: { cost: 270, wholesale: 300, retail: 320, vip: 310 }, units: [{ unit: "جهاز", price: 320, isDefault: true }, { unit: "كرتونة", price: 2800, isDefault: false }], stock: { quantity: 20, minLevel: 8, maxLevel: 60 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_007", code: "ITM-007", name: "هارد ديسك خارجي 2TB", category: "تخزين", prices: { cost: 380, wholesale: 420, retail: 450, vip: 430 }, units: [{ unit: "جهاز", price: 450, isDefault: true }, { unit: "كرتونة", price: 4000, isDefault: false }], stock: { quantity: 25, minLevel: 10, maxLevel: 70 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_008", code: "ITM-008", name: "بطارية لابتوب Dell", category: "ملحقات", prices: { cost: 280, wholesale: 320, retail: 350, vip: 330 }, units: [{ unit: "قطعة", price: 350, isDefault: true }, { unit: "كرتونة", price: 3000, isDefault: false }], stock: { quantity: 10, minLevel: 5, maxLevel: 40 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_009", code: "ITM-009", name: "كابل HDMI 2 متر", category: "كابلات", prices: { cost: 30, wholesale: 38, retail: 45, vip: 40 }, units: [{ unit: "قطعة", price: 45, isDefault: true }, { unit: "دزينة", price: 450, isDefault: false }, { unit: "كرتونة", price: 1800, isDefault: false }], stock: { quantity: 100, minLevel: 30, maxLevel: 200 }, tax: { exempt: true, rate: 0 }, status: "active" },
        { _id: "itm_010", code: "ITM-010", name: "سماعات رأس JBL", category: "صوتيات", prices: { cost: 140, wholesale: 160, retail: 180, vip: 170 }, units: [{ unit: "قطعة", price: 180, isDefault: true }, { unit: "دزينة", price: 1800, isDefault: false }, { unit: "كرتونة", price: 7000, isDefault: false }], stock: { quantity: 40, minLevel: 15, maxLevel: 100 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_011", code: "ITM-011", name: "ويب كام Logitech C920", category: "ملحقات", prices: { cost: 300, wholesale: 350, retail: 380, vip: 360 }, units: [{ unit: "جهاز", price: 380, isDefault: true }, { unit: "كرتونة", price: 3500, isDefault: false }], stock: { quantity: 18, minLevel: 5, maxLevel: 50 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_012", code: "ITM-012", name: "USB Flash 64GB", category: "تخزين", prices: { cost: 40, wholesale: 48, retail: 55, vip: 50 }, units: [{ unit: "قطعة", price: 55, isDefault: true }, { unit: "دزينة", price: 550, isDefault: false }, { unit: "كرتونة", price: 2200, isDefault: false }], stock: { quantity: 60, minLevel: 20, maxLevel: 150 }, tax: { exempt: true, rate: 0 }, status: "active" },
        { _id: "itm_013", code: "ITM-013", name: "مكبر صوت بلوتوث", category: "صوتيات", prices: { cost: 170, wholesale: 200, retail: 220, vip: 210 }, units: [{ unit: "جهاز", price: 220, isDefault: true }, { unit: "كرتونة", price: 2000, isDefault: false }], stock: { quantity: 22, minLevel: 8, maxLevel: 60 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_014", code: "ITM-014", name: "ستاند لابتوب ألومنيوم", category: "ملحقات", prices: { cost: 70, wholesale: 85, retail: 95, vip: 90 }, units: [{ unit: "قطعة", price: 95, isDefault: true }, { unit: "دزينة", price: 950, isDefault: false }, { unit: "كرتونة", price: 3500, isDefault: false }], stock: { quantity: 35, minLevel: 10, maxLevel: 80 }, tax: { exempt: true, rate: 0 }, status: "active" },
        { _id: "itm_015", code: "ITM-015", name: "حقيبة لابتوب 15.6 بوصة", category: "ملحقات", prices: { cost: 120, wholesale: 135, retail: 150, vip: 140 }, units: [{ unit: "قطعة", price: 150, isDefault: true }, { unit: "دزينة", price: 1500, isDefault: false }, { unit: "كرتونة", price: 5500, isDefault: false }], stock: { quantity: 28, minLevel: 10, maxLevel: 70 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_016", code: "ITM-016", name: "ماوس باد كبير", category: "ملحقات", prices: { cost: 25, wholesale: 30, retail: 35, vip: 32 }, units: [{ unit: "قطعة", price: 35, isDefault: true }, { unit: "دزينة", price: 350, isDefault: false }, { unit: "كرتونة", price: 1400, isDefault: false }], stock: { quantity: 80, minLevel: 25, maxLevel: 150 }, tax: { exempt: true, rate: 0 }, status: "active" },
        { _id: "itm_017", code: "ITM-017", name: "كابل USB-C", category: "كابلات", prices: { cost: 28, wholesale: 35, retail: 40, vip: 37 }, units: [{ unit: "قطعة", price: 40, isDefault: true }, { unit: "دزينة", price: 400, isDefault: false }, { unit: "كرتونة", price: 1600, isDefault: false }], stock: { quantity: 90, minLevel: 30, maxLevel: 200 }, tax: { exempt: true, rate: 0 }, status: "active" },
        { _id: "itm_018", code: "ITM-018", name: "شاحن لابتوب 65W", category: "ملحقات", prices: { cost: 140, wholesale: 165, retail: 180, vip: 170 }, units: [{ unit: "جهاز", price: 180, isDefault: true }, { unit: "كرتونة", price: 1600, isDefault: false }], stock: { quantity: 15, minLevel: 5, maxLevel: 50 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_019", code: "ITM-019", name: "SSD 500GB Samsung", category: "تخزين", prices: { cost: 260, wholesale: 300, retail: 320, vip: 310 }, units: [{ unit: "جهاز", price: 320, isDefault: true }, { unit: "كرتونة", price: 2800, isDefault: false }], stock: { quantity: 20, minLevel: 8, maxLevel: 60 }, tax: { exempt: false, rate: 15 }, status: "active" },
        { _id: "itm_020", code: "ITM-020", name: "RAM 16GB DDR4", category: "ذاكرة", prices: { cost: 230, wholesale: 260, retail: 280, vip: 270 }, units: [{ unit: "قطعة", price: 280, isDefault: true }, { unit: "كرتونة", price: 2500, isDefault: false }], stock: { quantity: 25, minLevel: 10, maxLevel: 70 }, tax: { exempt: false, rate: 15 }, status: "active" }
    ]
};
...
// =============================================
// Load Inventory (Transform MongoDB-style to UI format)
// =============================================
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Load inventory from INVENTORY_DATA
    loadInventoryItems();

    // Set dates
    const today = new Date().toISOString().split('T')[0];
    const dueDate = new Date();
    dueDate.setDate(dueDate.getDate() + CONFIG.DEFAULT_DUE_DAYS);
...
function setupEventListeners() {
    ...
    window.addEventListener('beforeunload', function (e) {
        if (invoiceItems.length > 0) {
            e.preventDefault();
            e.returnValue = 'لديك أصناف في الفاتورة لم يتم حفظها. هل تريد مغادرة الصفحة؟';
...
function renderInvoiceTable() {
    ...
    if (invoiceItems.length === 0) {
        tbody.innerHTML = '<tr><td onclick="openPopUpWindow(\'AddNewPopup\');setTimeout(initInvoicePopup,100)" colspan="12" class="NotFound">لا توجد أصناف في الفاتورة. اضغط "إضافة صنف" او F1 للبدء</td></tr>';
...
function removeItem(id) {
    if (!confirm('هل أنت متأكد من حذف هذا الصنف من الفاتورة؟')) return;
...
function saveInvoice() {
    ...
    ArbahToast.success('تم حفظ فاتورة المشتريات بنجاح!', 4000, { title: 'تم بنجاح!' });
    resetInvoice();
}

function collectInvoiceData() {
    return {
        invoiceNumber: document.querySelector('input[value^="' + CONFIG.INVOICE_PREFIX + '"')?.value || '',
...
function resetInvoice() {
    ...
    ['CashBoxSelect', 'BankSelect', 'CostCenter', 'Warehouse', 'SalesRep'].forEach(id => {
...
function printInvoice() {
    if (invoiceItems.length === 0) {
        ArbahToast.error('لا يمكن طباعة فاتورة فارغة!', 4000, { title: 'خطأ!' });
        return;
    }
    window.print();
}
